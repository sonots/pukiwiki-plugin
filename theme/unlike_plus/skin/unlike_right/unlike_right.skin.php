...
$wikinote_notepage_tabs = array(
     array('cmd'=>'edit', 'label'=>make_link('&multilang(en){Edit};&multilang(ja){編集};'), 'href'=>'?cmd=edit&amp;page=$page'),
     array('cmd'=>'diff', 'label'=>make_link('&multilang(en){Diff};&multilang(ja){差分};'), 'href'=>'?cmd=diff&amp;page=$page'),
     array('cmd'=>'main', 'label'=>make_link('&multilang(en){Article};&multilang(ja){本文};')),
     array('cmd'=>'note', 'label'=>make_link('&multilang(en){Comment};&multilang(ja){コメント};')),
);
...
<?php } ?>
 ...
 <link rel="stylesheet" href="<?php echo SKIN_URI ?>unlike_right/unlike_right.css" title="unlike" type="text/css" charset="<?php echo $css_charset ?>" />
 <link rel="stylesheet" href="<?php echo SKIN_URI ?>unlike_right/print.css" type="text/css" media="print" charset="<?php echo $css_charset ?>" />
